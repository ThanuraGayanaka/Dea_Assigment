...
public class contactus extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            PreparedStatement stmt= con.prepareStatement("INSERT INTO contact_us(senderid,sendername,email,telephone,sendersubject,sendermessage) VALUES(null,?,?,?,?,?)",PreparedStatement.RETURN_GENERATED_KEYS);
            stmt.setString(1, sendername);
            stmt.setString(2,email);
            stmt.setString(3, telephone);
            stmt.setString(4, sendersubject);
            stmt.setString(5, sendermessage);
            stmt.executeUpdate();
