<%-- 
    Document   : Contact_jsp
    Created on : 21-Sep-2020, 09:52:42
    Author     : Gayanaka
--%>
      ...
      <div class="navbar yellow navbar-default red2 yamm">
        ...
        <div id="navbar-collapse-grid" class="navbar-collapse collapse pull-right">
          <ul class="nav red2 navbar-nav">
            ...
            <li> <a href="reservation.jsp" class="dropdown-toggle">reservation</a></li>
            <li> <a href="contact.jsp" class="dropdown-toggle active">Contact</a></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
          ...
          <div class="smart-forms bmargin">
            ...
            <form method="post" action="php/smartprocess.php" id="smart-form">
              ...
              <div class="form-footer">
                <button type="submit" data-btntext-sending="Sending..." class="button btn-primary red-2">Submit</button>
        ...
        <div class="col-md-4 bmargin">
          ...
          <br />
          E-mail: <a href="mailto:email@example.com">Hotdevil@gmail.com</a><br />
          Website: <a href="index.html">www.hotdevil.com</a>
          <div class="clearfix"></div>
          <br/>
    ...
    <div class="container sec-tpadding-3 sec-bpadding-3">
      <div class="row">
        ...
        <div id="owl-demo2" class="owl-carousel">
          <div class="item">
            <div class="col-md-3 col-sm-6 bmargin text-left"> <img src="images\pexels-malidate-van-842142(1).jpg" alt="" class="img-responsive"/>
              <h5 class="text-white paddtop1"><a href="#">Grilled Meat with Rosemary</a></h5>
            </div>
            <!--end item-->
            
            <div class="col-md-3 col-sm-6 bmargin text-left"> <img src="images\pexels-engin-akyurt-1437267(1).jpg" alt="" class="img-responsive"/>
              <h5 class="text-white paddtop1"><a href="#">Macaroni Bolognese</a></h5>
            </div>
            <!--end item-->
            
            <div class="col-md-3 col-sm-6 bmargin text-left"> <img src="images\pexels-tomateoignons-3820638.jpg" alt="" class="img-responsive"/>
              <h5 class="text-white paddtop1"><a href="#">Spicy Kale Branch</a></h5>
            </div>
            <!--end item-->
            
            <div class="col-md-3 col-sm-6 bmargin text-left"> <img src="images\pexels-nishant-aneja-4203044.jpg" alt="" class="img-responsive"/>
      ...
      <div class="row">
        <div class="col-md-3 clearfix">
          ...
          <ul class="address-info-2">
            ...
            <li><i class="fa fa-phone"></i> Phone: (011) 567 8901</li>
            <li><i class="fa fa-fax"></i> Fax: + (011) 567 8901</li>
            <li><i class="fa fa-envelope"></i> Email: Hotdevil@gmail.com </li>
            <li class="last"><i class="fa fa-envelope"></i> Email: Hotdevil@gmail.com </li>
          </ul>
        </div>
        <!--end item-->
