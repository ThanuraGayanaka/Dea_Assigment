<%-- 
    Document   : About_jsp
    Created on : 21-Sep-2020, 09:51:30
    Author     : Gayanaka
--%>
    ...
    <div class="container">
      <div class="topbar-left-items">
        <ul class="toplist toppadding pull-left paddtop1">
          <li class="rightl"><i class="fa fa-phone"></i> 011 - 5678 - 9012</li>
      ...
      <div class="topbar-right-items pull-right">
        <ul class="toplist toppadding">
          ...
          <li>
            <h5 class="text-red-2 nopadding">(011) 123-4567</h5>
          </li>
        </ul>
      </div>
    </div>
      ...
      <div class="navbar yellow navbar-default red2 yamm">
        ...
        <div id="navbar-collapse-grid" class="navbar-collapse collapse pull-right">
          <ul class="nav red2 navbar-nav">
            ...
            <li> <a href="about.jsp" class="dropdown-toggle active">About</a></li>
  ...
  <section class="sec-padding">
    <div class="container">
      <div class="row">
        ...
        <div class="clearfix"></div>
        <div class="col-md-6 bmargin"> <img src="images\pexels-iconcom-1234535.jpg " alt="" class="img-responsive"/> </div>
        <!--end item-->
        ...
        <div class="col-md-6 bmargin"> <img src="images\pexels-dana-tentis-262959(1).jpg" alt="" class="img-responsive"/> </div>
        <!--end item--> 
      </div>
    </div>
  </section>
