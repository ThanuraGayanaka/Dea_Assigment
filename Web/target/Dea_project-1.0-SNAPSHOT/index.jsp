<%-- 
    Document   : index
    Created on : 21-Sep-2020, 10:08:30
    Author     : Gayanaka
--%>
...
<div class="site_wrapper">
    ...
    <div class="container">
      <div class="topbar-left-items">
        <ul class="toplist toppadding pull-left paddtop1">
          <li class="rightl"><i class="fa fa-phone"></i> 0112 - 548 - 254</li>
          <li><i class="fa fa-envelope"></i> hotdevil@gmail.com</li>
        </ul>
      </div>
      <!--end left-->
      ...
      <div class="topbar-right-items pull-right">
        <ul class="toplist toppadding">
          ...
          <li><h5 class="text-red-2 nopadding">(011) 487 2524</h5></li>
        </ul>
      </div>
    </div>
  </div>
      ...
      <div class="navbar yellow navbar-default red2 yamm">
        ...
        <div id="navbar-collapse-grid" class="navbar-collapse collapse pull-right">
          <ul class="nav red2 navbar-nav">
            <li> <a href="index.jsp" class="dropdown-toggle active">Home</a></li>
            <li> <a href="about.jsp" class="dropdown-toggle">About</a></li>
            <li> <a href="menu.jsp" class="dropdown-toggle">Menu</a></li>
            <li> <a href="special.jsp" class="dropdown-toggle">Special</a></li>
            <li> <a href="reservation.jsp" class="dropdown-toggle">Order Now</a></li>
            <li> <a href="contact.jsp" class="dropdown-toggle">Contact</a></li>
            <li> <a href="login.jsp" class="dropdown-toggle">Sign In</a></li>
  ...
  <div class="master-slider ms-skin-default" id="masterslider"> 
    ...
    <div class="ms-slide slide-1" data-delay="9">
      ...
      <img src="images\sliders\pexels-pixabay-461198.jpg"  alt="Tacos With Lime"/>
      ...
      <h3 class="ms-layer text18"
			...
			data-duration="1230"
			data-effect="left(250)"> Fresh taste at a</h3>
      ...
      <h3 class="ms-layer text19"
			...
			data-ease="easeOutExpo"
			data-duration="1230"
			data-effect="right(250)"> great price</h3>
            
      <h3 class="ms-layer text6 text-white"
        	style="top: 380px;"
            data-type="text"
            data-effect="top(45)"
            data-duration="2000"
      ...
      <a class="ms-layer sbut7"
			style="left: 750px; top: 470px;"
			data-type="text"
			data-delay="2000"
			data-ease="easeOutExpo"
			data-duration="1200"
			data-effect="scale(1.5,1.6)"> Book now </a>
             </div>
    <!-- end slide 1 --> 
    ...
    <div class="ms-slide slide-2" data-delay="9">
      <div class="slide-pattern"></div>
      <img src="images\sliders\masterslider\pexels-dima-valkov-3864682.jpg"  alt=""/>
    ...
    <div class="ms-slide slide-3" data-delay="9">
      <div class="slide-pattern"></div>
      <img src="images\sliders\masterslider\pexels-snapwire-675951.jpg"  alt="Beef Steak With Sauce"/>
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6">
          <div class="feature-box31 text-center bmargin">
            <div class="image-holder">
              ...
              <img src="images\pexels-julie-aagaard-2097090.jpg" alt="" class="img-responsive"/> </div>
            <div class="divider-line solid margin light"></div>
            <div class="clearfix"></div>
            <br/>
            <h4 class="old-standardtt uppercase">aliquam rhoncus</h4>
            <p>Lorem ipsum dolor sit amet sit et justo consectetuer adipiscing elit sit justo. Suspendisse et justo.</p>
            <br/>
            <a class="btn btn-border light red-2" href="#">Order now</a> </div>
        </div>
        <!--end item-->
        ...
        <div class="col-md-3 col-sm-6">
          <div class="feature-box31 text-center bmargin">
            <div class="image-holder">
              <div class="price">$29.9</div>
              <img src="images\pexels-pixabay-357573.jpg" alt="" class="img-responsive"/> </div>
            <div class="divider-line solid margin light"></div>
            <div class="clearfix"></div>
            <br/>
        ...
        <div class="col-md-3 col-sm-6">
          <div class="feature-box31 text-center bmargin">
            <div class="image-holder">
              <div class="price">$29.9</div>
              <img src="images\pexels-sebastian-coman-photography-3655916.jpg" alt="" class="img-responsive"/> </div>
            <div class="divider-line solid margin light"></div>
            <div class="clearfix"></div>
            <br/>
        ...
        <div class="col-md-3 col-sm-6">
          <div class="feature-box31 text-center bmargin">
            <div class="image-holder">
              <div class="price">$29.9</div>
              <img src="images\pexels-lumn-604969.jpg" alt="" class="img-responsive"/> </div>
            <div class="divider-line solid margin light"></div>
            <div class="clearfix"></div>
            <br/>
      ...
      <div class="container sec-tpadding-3 sec-bpadding-3">
        <div class="row">
          <div class="col-md-8 col-centered">
            ...
            <br/>
            <br/>
            <a class="btn btn-white btn-xround" href="#">Reserve</a> </div>
        </div>
      </div>
    </div>
  </section>
        ...
        <div class="col-md-4">
          <div class="feature-box32 bmargin">
            ...
            <div class="text-box-right more-padding-3">
              ...
              <br/>
              <a class="btn btn-border light btn-small red-2" href="#">Order now</a> </div>
          </div>
        </div>
        <!--end item-->
    ...
    <div class="container">
      ...
      <div class="row sec-tpadding-2 sec-bpadding-2">
        ...
        <div class="col-md-6 bmargin">
          <div class="image-holder"><img src="images/500300.jpg" alt="" class="img-responsive"/></div>
        </div>
        <!--end item-->
      ...
      <div class="container sec-tpadding-3 sec-bpadding-3">
        <div class="row">
          <div class="col-md-8 col-centered">
            ...
            <div class="iconbox-medium round overflow-hidden"><img src="http://placehold.it/110x110" alt=""/></div>
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6">
          <div class="feature-box31 text-center bmargin">
            <div class="image-holder">
              <div class="price">$29.9</div>
              <img src="http://placehold.it/300x280" alt="" class="img-responsive"/> </div>
            <div class="divider-line solid margin light"></div>
            <div class="clearfix"></div>
            <br/>
            <h4 class="old-standardtt uppercase">aliquam rhoncus</h4>
                ...
                <div class="feature-box33 bmargin">
                  <div class="col-md-6 col-sm-6 nopadding">
                    <div class="image-holder">
                      ...
                      <img src="images\pexels-valeria-boltneva-1860204.jpg" class="img-responsive" alt=""/> </div>
                  </div>
                  <div class="col-md-6 col-sm-6 nopadding">
                    <div class="text-box-inner text-left">
                      ...
                      <br/>
                      <a class="read-more" href="#"><i class="fa fa-long-arrow-right"></i> Read more</a> </div>
                  </div>
                </div>
              ...
              <div class="col-md-6 bmargin">
                <div class="feature-box33 bmargin">
                  <div class="col-md-6 col-sm-6 nopadding">
                    <div class="image-holder">
                      <div class="post-date-box"> 25 <span>May, 2015</span> </div>
                      <img src="images\pexels-harry-dona-2338407.jpg" class="img-responsive" alt=""/> </div>
                  </div>
                  <div class="col-md-6 col-sm-6 nopadding">
                    <div class="text-box-inner text-left">
              ...
              <div class="col-md-6 bmargin">
                <div class="feature-box33 bmargin">
                  <div class="col-md-6 col-sm-6 nopadding">
                    <div class="image-holder">
                      <div class="post-date-box"> 25 <span>May, 2015</span> </div>
                      <img src="images\pexels-pixabay-248444(1).jpg" class="img-responsive" alt=""/> </div>
                  </div>
                  <div class="col-md-6 col-sm-6 nopadding">
                    <div class="text-box-inner text-left">
                      <h4 class="old-standardtt uppercase"><a href="#">Donec libero</a></h4>
    ...
    <div class="container ">
      <div class="row">
        <div class="col-md-3 clearfix">
          <div class="footer-logo"><img src="bower.png" alt=""/></div>
        ...
        <div class="col-md-3 clearfix">
          <div class="item-holder">
            ...
            <div class="clearfix"></div>
            <div class="image-left"><img src="http://placehold.it/80x80" alt="" class="img-responsive"/></div>
