<%-- 
    ...
    Created on : 21-Sep-2020, 10:12:51
    Author     : Gayanaka
--%>
    ...
    <div class="container">
      ...
      <div class="topbar-right-items pull-right">
        <ul class="toplist toppadding">
          ...
          <li>
            <h5 class="text-red-2 nopadding">(011) 23-4567</h5>
          </li>
        </ul>
      </div>
    </div>
      ...
      <div class="navbar yellow navbar-default red2 yamm">
        ...
        <div id="navbar-collapse-grid" class="navbar-collapse collapse pull-right">
          <ul class="nav red2 navbar-nav">
            ...
            <li> <a href="reservation.jsp" class="dropdown-toggle active">reservation</a></li>
  ...
  <section>
    <div class="header-inner two">
      <div class="inner text-center">
        <h4 class="title text-white uppercase old-standardtt">Reservation</h4>
        <h5 class="text-white uppercase">Get many More Features</h5>
      </div>
      <div class="overlay bg-opacity-5"></div>
      <img src="images\about.png" alt="" class="img-responsive"/> </div>ss
  <!-- end header inner -->
  <div class="clearfix"></div>
  <section>
    <div class="pagenation-holder">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <h3 class="old-standardtt">Reservation</h3>
          </div>
          <div class="col-md-6 text-right">
            <div class="pagenation_links"><a href="index.html">Home</a> <i>/</i> Reservation</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12">
          ...
          <h1 class="section-title-4 great-vibes text-center">Make a Reservation</h1>
          <p class="sub-title text-center">Lorem ipsum dolor sit amet consectetuer adipiscing.</p>
        </div>
        <div class="clearfix"></div>
        <div class="col-md-6 bmargin"> <img src="images\pexels-anna-shvets-4482900.jpg" alt="" class="img-responsive"/> </div>
        <!--end item-->
        
        <div class="col-md-6">
          <h3 class="old-standardtt">ONLINE BOOKING</h3>
          <br/>
          <div class="res-form-holder bmargin">
            <form>
              <input type="text" name="Name" value="Name" class="half-width">
              <input type="text" name="Name" value="Phone Number" class="half-width last">
              <input type="text" name="Name" value="E-mail">
              <input type="text" name="Name" value="Time">
              <input type="text" name="Name" value="How Many Guests?">
              <button class="btn-res" value="book a table">Book a Table</button>
            </form>
          </div>
        </div>
        <!--end item--> 
