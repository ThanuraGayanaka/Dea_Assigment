<%-- 
    Document   : special
    Created on : 21-Sep-2020, 10:15:03
    Author     : Gayanaka
--%>
      ...
      <div class="navbar yellow navbar-default red2 yamm">
        ...
        <div id="navbar-collapse-grid" class="navbar-collapse collapse pull-right">
          <ul class="nav red2 navbar-nav">
            ...
            <li> <a href="special.jsp" class="dropdown-toggle active">Special</a></li>
  ...
  <section>
    <div class="header-inner two">
      <div class="inner text-center">
        <h4 class="title text-white uppercase old-standardtt">Special</h4>
  ...
  <section>
    <div class="pagenation-holder">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <h3 class="old-standardtt">Special</h3>
          </div>
          <div class="col-md-6 text-right">
            <div class="pagenation_links"><a href="index.html">Home</a> <i>/</i> Special</div>
          </div>
        </div>
      </div>
    </div>
